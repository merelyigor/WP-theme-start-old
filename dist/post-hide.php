<?php
/**
 * Скрытие постов учасников от других учасников которые не являются их авторами
 * ---------------------------------------------------------------------------------------------------------------------
 */

// Показать только сообщения и сообщения, связанные с авторизованным автором
...
// Исправить количество сообщений
