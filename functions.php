...
include_once 'inc/theme-support.php'; // Глобальные настройки темы и регистрация настроек
...
include_once 'inc/get-comments-TO-DOO.php'; // Получение коментариев
//include_once 'inc/get-post-settings.php'; // функции которые относятся к выводу постов на главной и странице рубрик
include_once 'inc/json-decoder.php'; // Работа с JSON масивами данных для вывода в верстку
include_once 'inc/nav-menu.php'; // Регистрация меню + убираем контейнер + убираю классы и id элементов меню
...
function special_nav_class_page($classes, $item)
{ //так же для текущих стр. и дочерних стр.
...
function custom_shortcode($atts)
{
    ...
    while (have_rows('docs')) {
        the_row(); // можно вывести кастомное поле которое добавляется к странице ACFом для вывода повторителя с файлом и тд.
