<?php
/**
 * Registration site bar in the template
 * for output use <?php get_sidebar(); ?>
 * ---------------------------------------------------------------------------------------------------------------------
 */
add_action('widgets_init', function () {
    register_sidebar(array(
        ...
        'id' => 'sidebar-1',
        'description' => __('Виджеты в этой области будут показаны на всех постах и ​​страницах.', 'the_theme_name'),
